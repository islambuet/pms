...
*/
$active_group = 'armalik_pms';
$query_builder = TRUE;

$db['armalik_pms']['hostname'] = '127.0.0.1';
$db['armalik_pms']['username'] = 'root';
$db['armalik_pms']['password'] = '';
$db['armalik_pms']['database'] = 'shaiful_arm_pms';
$db['armalik_pms']['dbdriver'] = 'mysqli';
$db['armalik_pms']['dbprefix'] = '';
$db['armalik_pms']['pconnect'] = TRUE;
$db['armalik_pms']['db_debug'] = TRUE;
$db['armalik_pms']['cache_on'] = FALSE;
$db['armalik_pms']['cachedir'] = '';
$db['armalik_pms']['char_set'] = 'utf8';
$db['armalik_pms']['dbcollat'] = 'utf8_general_ci';
$db['armalik_pms']['swap_pre'] = '';
$db['armalik_pms']['autoinit'] = TRUE;
$db['armalik_pms']['stricton'] = FALSE;
