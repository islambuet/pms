    ...
    <div class="row widget">
        ...
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="zone_id" name="territory[zone_id]" class="form-control" tabindex="-1">
        ...
        <div class="row show-grid">
            <div class="col-xs-4">
                <label class="control-label pull-right"><?php echo $this->lang->line('LABEL_TERRITORY_NAME');?><span style="color:#FF0000">*</span></label>
            </div>
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="territory[name]" id="name" class="form-control validate[required]" value="<?php echo $territory['name'];?>"/>
            </div>
        </div>
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="territory[remarks]" id="remarks" class="form-control validate[required]" value="<?php echo $territory['remarks'];?>"/>
            </div>
        </div>
        ...
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="status" name="territory[status]" class="form-control" tabindex="-1">
                    <!--<option value=""></option>-->
                    <option value="<?php echo $CI->config->item('system_status_active'); ?>"
                        <?php
                        if ($territory['status'] == $CI->config->item('system_status_active')) {
                    ...
                    <option value="<?php echo $CI->config->item('system_status_inactive'); ?>"
                        <?php
                        if ($territory['status'] == $CI->config->item('system_status_inactive')) {
                            echo "selected='selected'";
                        }
