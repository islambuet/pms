...
<div class="row widget">
    ...
    <div class="row show-grid" style="display: none" id="vehicle_no_container">
        <div class="col-xs-4">
            <label class="control-label pull-right"><?php echo $this->lang->line('LABEL_VEHICLE_NUMBER');?><span style="color:#FF0000">*</span></label>
        </div>
        <div class="col-xs-4">
...
jQuery(document).ready(function()
{
    ...
    {
        $("#detail_container").html("");
        var vehicle_loading_id=$('#vehicle_no').val();
        if(vehicle_loading_id>0)
        {
            $.ajax({
