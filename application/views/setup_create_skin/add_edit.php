    ...
    <div class="row widget">
        ...
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="crop_id" name="skin_type[crop_id]" class="form-control" tabindex="-1">
        ...
        <div style="<?php if(!($skin_type['classification_id']>0)){echo 'display:none';} ?>" class="row show-grid" id="classification_id_container">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="classification_id" name="skin_type[classification_id]" class="form-control" tabindex="-1">
                    <option value=""><?php echo $this->lang->line('SELECT');?></option>
                    <?php
