...
<form class="form_valid" id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save');?>" method="post">
    ...
    <div class="row show-grid">
        ...
        <div class="col-sm-4 col-xs-8">
            <input type="text" name="variety_price[unit_price]" id="unit_price" class="form-control float_type_positive" style="text-align: left;" value="<?php echo $variety_price['unit_price'];?>"/>
        </div>
    </div>
    <div class="row show-grid">
        <div class="col-xs-4">
