...
<form class="form_valid" id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="crop_id" class="form-control" tabindex="-1">
                    ...
                    {?>
                        <option value="<?php echo $crop['value']?>" <?php if($crop['value']==$skin_type['crop_id']){ echo "selected";}?>><?php echo $crop['text'];?></option>
                    <?php
                    }
                    ?>
                </select>
        ...
        <div style="<?php if(!($skin_type['classification_id']>0)){echo 'display:none';} ?>" class="row show-grid" id="classification_id_container">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="classification_id" class="form-control" tabindex="-1">
                    ...
                    {?>
                        <option value="<?php echo $classification['value']?>" <?php if($classification['value']==$skin_type['classification_id']){ echo "selected";}?>><?php echo $classification['text'];?></option>
                    <?php
                    }
                    ?>
                </select>
        ...
        <div style="<?php if(!($skin_type['type_id']>0)){echo 'display:none';} ?>" class="row show-grid" id="type_id_container">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="type_id" name="skin_type[type_id]" class="form-control" tabindex="-1">
                    ...
                    {?>
                        <option value="<?php echo $type['value']?>" <?php if($type['value']==$skin_type['type_id']){ echo "selected";}?>><?php echo $type['text'];?></option>
                    <?php
                    }
                    ?>
                </select>
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="skin_type[name]" id="name" class="form-control validate[required]" value="<?php echo $skin_type['name'];?>"/>
            </div>
        </div>
