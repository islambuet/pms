...
<form class="form_valid" id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div style="<?php if(!($union['upazila_id']>0)){echo 'display:none';} ?>" class="row show-grid" id="upazila_id_container">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="upazila_id" name="union[upazila_id]" class="form-control" tabindex="-1">
                    ...
                    {?>
                        <option value="<?php echo $upazila['value']?>" <?php if($upazila['value']==$union['upazila_id']){ echo "selected";}?>><?php echo $upazila['text'];?></option>
                    <?php
                    }
                    ?>
                </select>
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="union[name]" id="name" class="form-control validate[required]" value="<?php echo $union['name'];?>"/>
            </div>
        </div>
