    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="crop[crop_name]" id="crop_name" class="form-control validate[required]" value="<?php echo $crop['crop_name'];?>"/>
            </div>
        </div>
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="crop[remarks]" id="remarks" class="form-control validate[required]" value="<?php echo $crop['remarks'];?>"/>
            </div>
        </div>
        ...
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="status" name="crop[status]" class="form-control" tabindex="-1">
                    <!--<option value=""></option>-->
