...
jQuery(document).ready(function()
{
    ...
    $(document).on("click", ".system_add_more_button", function(event)
    {
        ...
        $('#system_add_more_content .variety').attr('data-index',current_id);
        $('#system_add_more_content .quantity').attr('name','booked_varieties['+current_id+'][quantity]');
        $('#system_add_more_content .quantity').attr('data-index',current_id);
        $('#system_add_more_content .quantity').attr('id','booked_varieties_'+current_id+'_quantity');
        $('#system_add_more_content .unit_price').attr('name','booked_varieties['+current_id+'][unit_price]');
        $('#system_add_more_content .unit_price').attr('data-index',current_id);
        $('#system_add_more_content .unit_price').attr('id','booked_varieties_'+current_id+'_unit_price');
        $('#system_add_more_content .discount').attr('name','booked_varieties['+current_id+'][discount]');
        $('#system_add_more_content .discount').attr('data-index',current_id);
        $('#system_add_more_content .discount').attr('id','booked_varieties_'+current_id+'_discount');
        $('#system_add_more_content .total').attr('data-index',current_id);
        $('#system_add_more_content .total').attr('id','booked_varieties_'+current_id+'_total');

        var html=$('#system_add_more_content table tbody').html();
        $(".system_add_more_button").closest('tr').before(html);
    ...
    $(document).on("change", ".variety", function(event)
    {
        ...
        if(variety_id>0)
        {
            price=$("#variety_unit_price_"+variety_id).val();
        }
        $('#booked_varieties_'+index+'_unit_price').val(price);
