...
<div class="row widget">
    ...
    if(isset($CI->permissions['action6'])&&($CI->permissions['action6']==1))
    {
        ...
        <div class="col-xs-12" style="margin-bottom: 20px;">
            <div class="col-xs-12" style="margin-bottom: 20px;">
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="customer_name"><?php echo $CI->lang->line('LABEL_NAME'); ?></label>
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="customer_custom_id"><?php echo $CI->lang->line('LABEL_CUSTOMER_ID'); ?></label>
                ...
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="contact_no"><?php echo $CI->lang->line('LABEL_CONTACT_NO'); ?></label>
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columnsreorder: true,
                columns: [
                    { text: '<?php echo $CI->lang->line('LABEL_NAME'); ?>', dataField: 'customer_name',width:'150',pinned:true},
                    { text: '<?php echo $CI->lang->line('LABEL_CUSTOMER_ID'); ?>', dataField: 'customer_custom_id',cellsalign: 'right',width:'100',pinned:true},
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_UPAZILA_NAME'); ?>', dataField: 'upazila_name',width:'100'},
                    { text: '<?php echo $CI->lang->line('LABEL_UNION_NAME'); ?>', dataField: 'union_name',width:'100'},
                    { text: '<?php echo $CI->lang->line('LABEL_CONTACT_NO'); ?>', dataField: 'contact_no',width:'100'},
                    { text: '<?php echo $CI->lang->line('LABEL_EMAIL'); ?>', dataField: 'email',width:'100'},
