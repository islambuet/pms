...
<form class="form_valid" id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div style="<?php if(!($customer['upazila_id']>0)){echo 'display:none';} ?>" class="row show-grid" id="upazila_id_container">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="upazila_id" class="form-control" tabindex="-1">
                    ...
                    {?>
                        <option value="<?php echo $upazila['value']?>" <?php if($upazila['value']==$customer['upazila_id']){ echo "selected";}?>><?php echo $upazila['text'];?></option>
                    <?php
                    }
                    ?>
                </select>
        ...
        <div style="<?php if(!($customer['union_id']>0)){echo 'display:none';} ?>" class="row show-grid" id="union_id_container">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="union_id" name="customer[union_id]" class="form-control" tabindex="-1">
                    ...
                    {?>
                        <option value="<?php echo $union['value']?>" <?php if($union['value']==$customer['union_id']){ echo "selected";}?>><?php echo $union['text'];?></option>
                    <?php
                    }
                    ?>
                </select>
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="customer[name]" id="name" class="form-control validate[required]" value="<?php echo $customer['name'];?>"/>
            </div>
        </div>
        <div class="row show-grid">
            <div class="col-xs-4">
