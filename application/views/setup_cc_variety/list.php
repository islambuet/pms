        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columnsreorder: true,
                columns: [
                    { text: '<?php echo $CI->lang->line('LABEL_CROP_NAME'); ?>', dataField: 'crop_name',width:'100',pinned:true},
                    { text: '<?php echo $CI->lang->line('LABEL_CLASSIFICATION_NAME'); ?>', dataField: 'classification_name',width:'150',pinned:true},
                    { text: '<?php echo $CI->lang->line('LABEL_TYPE_NAME'); ?>', dataField: 'type_name',width:'100',pinned:true},
                    { text: '<?php echo $CI->lang->line('LABEL_SKIN_TYPE_NAME'); ?>', dataField: 'skin_type_name',width:'100',pinned:true},
