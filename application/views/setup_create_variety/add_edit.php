        ...
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="crop_id" name="variety[crop_id]" class="form-control" tabindex="-1">
                    ...
                    {?>
                        <option value="<?php echo $crop['id']?>" <?php if($crop['id']==$variety['crop_id']){ echo "selected";}?>><?php echo $crop['crop_name'];?></option>
                    <?php
                    }
                    ?>
                </select>
        ...
        <div style="<?php if(!($variety['classification_id']>0)){echo 'display:none';} ?>" class="row show-grid" id="classification_id_container">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="classification_id" name="variety[classification_id]" class="form-control" tabindex="-1">
                    ...
                    {?>
                        <option value="<?php echo $classification['id']?>" <?php if($classification['id']==$variety['classification_id']){ echo "selected";}?>><?php echo $classification['classification_name'];?></option>
                    <?php
                    }
                    ?>
                </select>
        ...
        <div style="<?php if(!($variety['type_id']>0)){echo 'display:none';} ?>" class="row show-grid" id="type_id_container">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="type_id" name="variety[type_id]" class="form-control" tabindex="-1">
                    ...
                    {?>
                        <option value="<?php echo $type['id']?>" <?php if($type['id']==$variety['type_id']){ echo "selected";}?>><?php echo $type['type_name'];?></option>
                    <?php
                    }
                    ?>
                </select>
        ...
        <div style="<?php if(!($variety['skin_type_id']>0)){echo 'display:none';} ?>" class="row show-grid" id="skin_type_id_container">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="skin_type_id" name="variety[skin_type_id]" class="form-control" tabindex="-1">
                    ...
                    {?>
                        <option value="<?php echo $skin_type['id']?>" <?php if($skin_type['id']==$variety['skin_type_id']){ echo "selected";}?>><?php echo $skin_type['skin_type_name'];?></option>
                    <?php
                    }
                    ?>
                </select>
