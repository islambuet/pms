...
class Setup_create_crop extends Root_Controller
{
    private  $message;
    public $permissions;
    ...
    public function __construct()
    {
        parent::__construct();
        $this->message="";
        $this->permissions=User_helper::get_permission('Setup_create_crop');
        ...
        $this->controller_url='setup_create_crop';
    ...
    public function system_list()
    {
        ...
        if(isset($this->permissions['view'])&&($this->permissions['view']==1))
        {
            ...
            $ajax['status']=true;
            $ajax['system_content'][]=array("id"=>"#system_content","html"=>$this->load->view("setup_create_crop/list",$data,true));
            if($this->message)
            {
